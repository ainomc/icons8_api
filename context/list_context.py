...
class ContextListApi(object):
    ...
    platform_list = ["Windows 8/Metro", "iPhone/iOS 10", "iPhone/iOS 7",
                     "Android", "Android L", "Color", "Windows 10/Threshold",
                     "Office", "Material", "Gradient", "Ultraviolet", "Nolan",
                     "DottyDots", "Red Short Lines", "iPhone/iOS 11", "1em"]
